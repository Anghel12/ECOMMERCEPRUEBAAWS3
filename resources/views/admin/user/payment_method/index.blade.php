                 ...
                 <div class="col-lg-3 col-md-4 col-12 border-end d-none d-md-block">
                    ...
                    <div class="pt-10 pe-lg-10">
                       ...
                       <ul class="nav flex-column nav-pills nav-pills-dark">
                          <!-- nav item -->
                          <li class="nav-item">
                           <a class="nav-link" aria-current="page" href="{{ route('admin.user.cart.index') }}">
                         ...
                         <!-- nav item -->
                         <li class="nav-item">
                            <a class="nav-link " href="{{ route('admin.user.setting.index') }}">
                         ...
                         <!-- nav item -->
                         <li class="nav-item">
                           <a class="nav-link active" href="{{ route('admin.user.payment_method.index') }}">
                 ...
                 <div class="col-lg-9 col-md-8 col-12">
                    <div class="py-6 p-md-6 p-lg-10">
                       ...
                       <div class="d-flex justify-content-between mb-6 align-items-center">
                          ...
                          <a href="account-payment-method.html#" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#paymentModal">Add Payment</a>
                       </div>
                       <ul class="list-group list-group-flush">
                          ...
                          <li class="list-group-item py-5 px-0">
                             <div class="d-flex justify-content-between">
                                ...
                                <div>
                                   <!-- button -->
                                   <a href="account-payment-method.html#" class="btn btn-outline-gray-400 disabled btn-sm">Remove</a>
                                </div>
                             </div>
                          </li>
                          <!-- List group item -->
                          <li class="list-group-item px-0 py-5">
                             <div class="d-flex justify-content-between">
                                ...
                                <div>
                                   <!-- button-->
                                   <a href="account-payment-method.html#" class="btn btn-outline-gray-400 text-muted btn-sm">Remove</a>
                                </div>
                             </div>
                          </li>
                          <!-- List group item -->
