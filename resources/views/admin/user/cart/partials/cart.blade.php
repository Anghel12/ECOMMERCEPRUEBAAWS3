					...
					<div class="col-lg-8 col-md-7">
						<div class="py-3">
							...
							<div class="alert alert-danger p-2" role="alert">
								...
								<a href="shop-cart.html#!" class="alert-link">checkout now!</a>
							</div>
								...
								<li class="list-group-item py-3 ps-0">
									...
									<div class="row align-items-center">
										<div class="col-6 col-md-6 col-lg-7">
											<div class="d-flex">{{--  --}}
												<img src="{{Storage::url($item->options->urlfoto)}}" alt="Ecommerce" class="icon-shape icon-xxl" />
												<div class="ms-3">
													...
													<div class="mt-2 small lh-1">
														<a href="shop-cart.html#!" class="text-decoration-none text-inherit">
							...
							<div class="d-flex justify-content-between mt-4">
								...
								<a href="{{ url('/vercarrito') }}" class="btn btn-dark">Update Cart</a>
							</div>
						</div>
					</div>
						...
						<div class="mb-5 card mt-6">
							<div class="card-body p-6">
								...
								<div class="d-grid mb-1 mt-4">
									<!-- btn -->
									<a class="btn btn-primary btn-lg d-flex justify-content-between align-items-center" href="{{ url('/checkout') }}">
										Go to Checkout
								...
								<p>
									<small>
										...
										and
										<a href="shop-cart.html#!">Privacy Policy.</a>
									</small>
								</p>
