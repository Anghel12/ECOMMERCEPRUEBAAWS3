    ...
    <div class="accordion-item py-4">
        <a href="shop-checkout.html#" class="text-inherit collapsed h5"
        ...
        <div id="flush-collapseTwo" class="accordion-collapse collapse"
                ...
                <div class="tab-pane fade show active" id="pills-today" role="tabpanel"
                    ...
                    <ul class="list-group list-group-flush mt-4">
                        ...
                        <li
                            ...
                            <!-- col -->
                            <div class="col-2 text-end"><a href="shop-checkout.html#"
            ...
            <div class="mt-5 d-flex justify-content-end">
                <a href="shop-checkout.html#" class="btn btn-outline-gray-400 text-muted"
                    data-bs-toggle="collapse" data-bs-target="#flush-collapseOne"
                    aria-expanded="false" aria-controls="flush-collapseOne">
                    Prev
                </a>
                <a href="shop-checkout.html#" class="btn btn-primary ms-2"
