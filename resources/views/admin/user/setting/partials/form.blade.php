    <div class="col-lg-9 col-md-8 col-12">
               <div class="py-6 p-md-6 p-lg-10">
                     ...
                     <form class="row row-cols-1 row-cols-lg-2">
                        ...
                        <div class="col-12">
                           <p class="mb-4">
                              ...
                              <a href="account-settings.html#">Reset your password.</a>
                           </p>
                           <a href="account-settings.html#" class="btn btn-primary">Save Password</a>
                        </div>
                     </form>
                  </div>
                  <hr class="my-10" />
                  <div>
                     ...
                     <!-- btn -->
                     <a href="account-settings.html#" class="btn btn-outline-danger">I want to delete my account</a>
                  </div>
               </div>
            </div>
