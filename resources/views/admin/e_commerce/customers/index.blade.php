                        ...
                        <div>
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    <li class="breadcrumb-item"><a href="customers.html#" class="text-inherit">Dashboard</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Customers</li>
                                </ol>
                            </nav>
                        </div>
                        <div>
                            <a href="customers.html#!" class="btn btn-primary">Add New Customer</a>
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-2">
                                                        <a href="customers.html#" class="text-inherit">Bonnie Howe</a>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    <a href="customers.html#" class="text-reset" data-bs-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-2">
                                                        <a href="customers.html#" class="text-inherit">Judy Nelson</a>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-2">
                                                        <a href="customers.html#" class="text-inherit">John Mattox</a>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-2">
                                                        <a href="customers.html#" class="text-inherit">Wayne Rossman</a>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-2">
                                                        <a href="customers.html#" class="text-inherit">Rhonda Pinson</a>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-2">
                                                        <a href="customers.html#" class="text-inherit">Richard Shelton</a>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-2">
                                                        <a href="customers.html#" class="text-inherit">Stephanie Morales</a>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-2">
                                                        <a href="customers.html#" class="text-inherit">Pasquale Kidd</a>
                                                    </div>
                                                </div>
                                            </td>
                            ...
                            <div class="border-top d-md-flex justify-content-between align-items-center p-6">
                                ...
                                <nav class="mt-2 mt-md-0">
                                    <ul class="pagination mb-0">
                                        <li class="page-item disabled"><a class="page-link" href="customers.html#!">Previous</a></li>
                                        <li class="page-item"><a class="page-link active" href="customers.html#!">1</a></li>
                                        <li class="page-item"><a class="page-link" href="customers.html#!">2</a></li>
                                        <li class="page-item"><a class="page-link" href="customers.html#!">3</a></li>
                                        <li class="page-item"><a class="page-link" href="customers.html#!">Next</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
