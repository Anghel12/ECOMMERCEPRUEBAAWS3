                ...
                <div class="col-md-12">
                    ...
                    <div class="card bg-light border-0 rounded-4"
                        ...
                        <div class="card-body p-lg-12">
                            ...
                            <a href="index.html#" class="btn btn-primary">Create Product</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card-body px-6 py-8">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-4">
                                        ...
                                        <p class="mb-0">
                                            You have
                                            <a class="link-info" href="index.html#!">2 new notification</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body px-6 py-8">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-4">
                                        ...
                                        <p class="mb-0"><a class="link-info" href="index.html#!">View
                                                Performance</a></p>
                                    </div>
                                </div>
                            </div>
