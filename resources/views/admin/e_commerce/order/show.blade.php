           ...
           <div class="row mb-8">
              <div class="col-md-12">
                 <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-4">
                    <div>
                       ...
                       <nav aria-label="breadcrumb">
                          <ol class="breadcrumb mb-0">
                             <li class="breadcrumb-item"><a href="order-single.html#" class="text-inherit">Dashboard</a></li>
                    ...
                    <!-- button -->
                    <div>
                       <a href="order-single.html#" class="btn btn-primary">Back to all orders</a>
                    </div>
                 </div>
              </div>
           </div>
                    ...
                    <div class="card-body p-6">
                       <div class="d-md-flex justify-content-between">
                          ...
                          <div class="d-md-flex">
                             ...
                             <!-- button -->
                             <div class="ms-md-3">
                                <a href="order-single.html#" class="btn btn-primary">Save</a>
                                <a href="order-single.html#" class="btn btn-secondary">Download Invoice</a>
                             </div>
                          </div>
                       </div>
                       <div class="mt-8">
                          <div class="row">
                             ...
                             <div class="col-lg-4 col-md-4 col-12">
                                <div class="mb-6">
                                   ...
                                   <a href="order-single.html#">View Profile</a>
                                </div>
                             </div>
                             <!-- address -->
                             <div class="col-lg-4 col-md-4 col-12">
                          ...
                          <div class="table-responsive">
                             ...
                             <table class="table mb-0 text-nowrap table-centered">
                                ...
                                <tbody>
                                   <tr>
                                      <td>
                                         <a href="order-single.html#" class="text-inherit">
                    ...
                    <div class="card-body p-6">
                       <div class="row">
                          ...
                          <div class="col-md-6">
                             ...
                             <a href="order-single.html#" class="btn btn-primary">Save Notes</a>
                          </div>
                       </div>
                    </div>
                 </div>
