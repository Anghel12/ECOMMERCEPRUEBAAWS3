<div>{{-- {{ $activeSection === 'products' ? ' active' : ''  }} --}}
				...
				<div class="navbar-vertical">
					...
					<div class="navbar-vertical-content flex-grow-1" data-simplebar="">
						<ul class="navbar-nav flex-column" id="sideNavbar">
							<li class="nav-item">
								<a class="nav-link {{ $activeSection === 'dashboard' ? ' active' : '' }}" href="{{ url('admin/dashboard') }}">
							...
							<li class="nav-item">
								<a class="nav-link {{ $activeSection === 'products' ? ' active' : '' }}" href="{{ url('admin/products') }}">
									<div class="d-flex align-items-center">
							...
							<li class="nav-item">
								<a class="nav-link {{ $activeSection === 'categories' ? ' active' : ''  }}" href="{{ url('admin/categories') }}">
									<div class="d-flex align-items-center">
							...
							<li class="nav-item">
								<a class="nav-link  collapsed " href="index.html#" data-bs-toggle="collapse"
								...
								<div id="navCategoriesOrders" class="collapse " data-bs-parent="#sideNavbar">
									<ul class="nav flex-column">
										<li class="nav-item">
											<a class="nav-link {{ $activeSection === 'order' ? ' active' : ''  }}" href="{{ url('admin/order') }}">List</a>
										</li>
										<!-- Nav item -->
										<li class="nav-item">
							...
							<li class="nav-item">
								...
								<div id="navMenuLevelFirst" class="collapse " data-bs-parent="#sideNavbar">
									<ul class="nav flex-column">
										<li class="nav-item">
											<a class="nav-link " href="index.html#" data-bs-toggle="collapse"
											...
											<div id="navMenuLevelSecond1" class="collapse"
												...
												<ul class="nav flex-column">
													<li class="nav-item">
														<a class="nav-link " href="index.html#">NavItem 1</a>
													</li>
													<li class="nav-item">
														<a class="nav-link " href="index.html#">NavItem 2</a>
													</li>
												</ul>
											</div>
										</li>
												...
												<ul class="nav flex-column">
													<li class="nav-item">
														...
														<div id="navMenuLevelThreeTwo" class="collapse collapse "
															...
															<ul class="nav flex-column">
																<li class="nav-item">
																	<a class="nav-link " href="index.html#">NavChild
																		Item 1</a>
																</li>
															</ul>
														</div>
													...
													<li class="nav-item">
														<a class="nav-link " href="index.html#">Nav Item 2</a>
													</li>
												</ul>
											</div>
										</li>
