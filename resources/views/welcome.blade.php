                        ...
                        <div class="card card-product">
                            <div class="card-body">
                                <div class="text-center position-relative">
                                    ...
                                    <a href="index.html#!"><img src="assets/images/products/product-img-1.jpg" alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
                    ...
                    <div class="col">
                        <div class="card card-product">
                            <div class="card-body">
                                ...
                                <div class="text-small mb-1">
                                    <a href="index.html#!" class="text-decoration-none text-muted"><small>Instant Food</small></a>
                                </div>
                        ...
                        <div class="card card-product">
                            <div class="card-body">
                                <div class="text-center position-relative">
                                    ...
                                    <a href="index.html#!"><img src="assets/images/products/product-img-6.jpg" alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
                                    <div class="card-product-action">
                                        <a href="index.html#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal">
                                            <i class="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" title="Quick View"></i>
                                        </a>
                                ...
                                <div class="text-small mb-1">
                                    <a href="index.html#!" class="text-decoration-none text-muted"><small>Dairy, Bread & Eggs</small></a>
                                </div>
